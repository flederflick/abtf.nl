    ...
    <div class="container">
        <div class="box">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="center">
                        <h2>Persoonlijk Score Overzicht</h2>
                    </div>
                    <div>
                        ...
                        <div class="col-lg-12" id="persoonsklasseschema"></div>
...
<script>
    ...
    $("#loader").show();
    $("#persoonsklasseschema").load("overzicht_persoonscore-return.php", {persoonsklasse: selectedklasse}, function () {
        $("#loader").hide();
    });

    $("#selectklasse").change(function () {
        $("#persoonsklasseschema").empty();
        $("#loader").show();
